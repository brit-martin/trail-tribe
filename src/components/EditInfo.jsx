  ...
  async function oldPasswordHandler() {
    ...
    try {
      ...
      if (error.response.status === 400) {
        ...
        console.error('Error during old password request:', error.response.status);
      }
    }
    setNewPassword('');
    setConfirmPassword('');
          ...
          <FormGroup>
            ...
            <div className='text__container'>
              ...
              <div style={passwordStyle}>
                <Button key='password change' onClick={handleOpen} sx={secHoverSX} color='primary'>
                  Change Password
                </Button>
                <Modal
                  open={openModal}
                    ...
                    {verified ? (
                      <>
                        ...
                        <FormControl
                          ...
                          autoComplete='off'
                        >
                          <InputLabel htmlFor='outlined-adornment-password' color='black'>
                            New Password
                          </InputLabel>
                          <OutlinedInput
                        ...
                        >
                          ...
                          />
                          <Button onClick={changePasswordHandler} sx={terHoverSX}>
                            Verify Password
                          </Button>
                        </FormControl>
                      </>
